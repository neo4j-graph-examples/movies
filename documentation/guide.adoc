...
:pass[<small>:help</small> <a help-topic="match">MATCH</a>]
...
WARN: Note you only need to compare property values like this when first creating relationships
...
:pass[<small>:help</small> <a help-topic="delete">DELETE</a>]
...
* :pass[<a play-topic="northwind-graph">Northwind Graph</a> - from RDBMS to graph]
